...
import com.cms.dao.contents.faq.FaqrankDao;
import com.cms.dto.common.ResponseCode;
import com.cms.dto.contents.faq.Faq;

@Service
public class FaqrankService {

	@Autowired private FaqrankDao faqRankDao;
	
		
	public List<Faq> getFaqList(String param) {
		return faqRankDao.getFaqList(param);
	}
