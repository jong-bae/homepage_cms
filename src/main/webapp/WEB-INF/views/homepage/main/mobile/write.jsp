					...
					<form role="form" id="quickForm" method="post" action="write-proc.do" enctype="multipart/form-data" onsubmit="return validation();">
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-3">
									<div class="custom-file">
										<input type="file" name="bannerImg_file_pc" class="custom-file-input" id="bannerImg_pc">
										<label class="custom-file-label" for="bannerImg_pc">상단 배너이미지 업로드</label>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-3">
									<div class="custom-file">
										<input type="file" name="bannerImg_file" class="custom-file-input" id="bannerImg" accept="image/*">
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<input type="text" name="titleTop" class="form-control" id="titleTop" placeholder="7자 내외로 입력하세요" >
								</div>
							</div>
							<div class="form-group row">
								<label for="titleMain" class="col-sm-2 col-form-label">MAIN타이틀</label>
								<div class="col-sm-5">
									<input type="text" name="titleMain" class="form-control" id="titleMain" placeholder="13자 내외로 입력하세요">
								</div>
							</div>
							<div class="form-group row">
								<label for="description" class="col-sm-2 col-form-label">설명</label>
								<div class="col-sm-10">
									<input type="text" name="description" class="form-control" id="description" placeholder="배너 설명">
								</div>
							</div>
							<div class="form-group row">
...
<script>
	...
	function validation() {
		...
		//if(!formValidation_empty('bannerImg')) return false;
