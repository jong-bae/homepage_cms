					...
					<form role="form" id="quickForm" method="post" action="write-proc.do" enctype="multipart/form-data">
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-2">
									<input type="text" name="bName" class="form-control" id="bName" placeholder="병의원명" required="required">
								</div>
							</div>
							<div class="form-group row">
								<label for="bFolder" class="col-sm-2 col-form-label">구분폴더명</label>
								<div class="col-sm-3">
									<input type="text" name="bFolder" class="form-control" id="bFolder" placeholder="폴더명">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" name="bAddr" class="form-control" id="bAddr" placeholder="주소" required="required">
								</div>
							</div>
							<div class="form-group row">
								<label for="bDomain" class="col-sm-2 col-form-label">홈페이지 URL</label>
								<div class="col-sm-5">
									<input type="text" name="bDomain" class="form-control" id="bDomain" placeholder="http://www.jaseng.co.kr">
								</div>
							</div>
							<div class="form-group row">
								<label for="kakaopf" class="col-sm-2 col-form-label">카카오플친 URL</label>
								<div class="col-sm-5">
									<input type="text" name="kakaopf" class="form-control" id="kakaopf" placeholder="https://pf.kakao.com">
								</div>
							</div>
							<%--<div class="form-group row">
								<label for="facebook" class="col-sm-2 col-form-label">페이스북 URL</label>
								<div class="col-sm-5">
									<input type="text" name="facebook" class="form-control" id="facebook" placeholder="http://www.facebook.com">
								</div>
							</div>--%>
							<div class="form-group row">
								<label for="blog" class="col-sm-2 col-form-label">블로그 URL</label>
								<div class="col-sm-5">
									<input type="text" name="blog" class="form-control" id="blog" placeholder="http://blog.naver.com">
								</div>
							</div>
							<div class="form-group row">
								<label for="cafe" class="col-sm-2 col-form-label">카페 URL</label>
								<div class="col-sm-5">
									<input type="text" name="cafe" class="form-control" id="cafe" placeholder="http://cafe.naver.com">
								</div>
							</div>
							<div class="form-group row">
								<label for="npost" class="col-sm-2 col-form-label">포스트 URL</label>
								<div class="col-sm-5">
									<input type="text" name="npost" class="form-control" id="npost" placeholder="http://post.naver.com">
								</div>
							</div>
							<%--<div class="form-group row">
								<label for="audioclip" class="col-sm-2 col-form-label">오디오클립 URL</label>
								<div class="col-sm-5">
									<input type="text" name="audioclip" class="form-control" id="audioclip" placeholder="https://audioclip.naver.com/channels/">
								</div>
							</div>--%>
							<div class="form-group row">
								<label for="youtube" class="col-sm-2 col-form-label">유튜브 URL</label>
								<div class="col-sm-5">
									<input type="text" name="youtube" class="form-control" id="youtube" placeholder="http://www.youtube.com">
								</div>
							</div>
							<div class="form-group row">
								<label for="instagram" class="col-sm-2 col-form-label">인스타그램 URL</label>
								<div class="col-sm-5">
									<input type="text" name="instagram" class="form-control" id="instagram" placeholder="https://www.instagram.com/">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-3">
									<div class="custom-file">
										<input type="file" name="bCiImg_file" class="custom-file-input" id="bCiImg">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-4">
											<input type="text" name="bCertTxt01" class="form-control" id="bCertTxt01">
										</div>
										<div class="col-sm-4">
											<div class="custom-file">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-4">
											<input type="text" name="bCertTxt02" class="form-control" id="bCertTxt02">
										</div>
										<div class="col-sm-4">
											<div class="custom-file">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<textarea class="form-control" rows="3" name="bSearchAddr" id="bSearchAddr"></textarea>
								</div>
							</div>
							<div class="form-group row">
								<label for="bFooterTxt1" class="col-sm-2 col-form-label">푸터텍스트1</label>
								<div class="col-sm-10">
									<input type="text" name="bFooterTxt1" class="form-control" id="bFooterTxt1">
								</div>
							</div>
							<div class="form-group row">
								<label for="bFooterTxt2" class="col-sm-2 col-form-label">푸터텍스트2</label>
								<div class="col-sm-10">
									<textarea class="form-control" rows="2" name="bFooterTxt2" id="bFooterTxt2"></textarea>
								</div>
							</div>
						</div>
