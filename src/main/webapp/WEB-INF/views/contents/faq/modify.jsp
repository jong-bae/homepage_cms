				...
				<div class="card card-info">
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="subject" class="form-control" id="subject" value='<c:out value="${data.subject }"></c:out>' placeholder="제목" required="required">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea name="contents" id="contents" rows="15" cols="163" class="form-control">${data.contents }</textarea>
							</div>
						</div>
					</div>
