			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">자주문는 질문관리</li>
					</ol>
				</div>
			</div>
		</div>
...
<script>
	$(function() {
		var list = $('#listTable').DataTable({
			...
			columns : [
				{ 'data' : 'category', 'defaultContent' : '', 'width': '15%'},					
				{ 'data' : 'branchOpen', 'defaultContent': '', 'width': '10%'	},
				{ 'data' : 'subject', 'defaultContent': '', 'width': '35%'	},
				{ 'data' : 'regDate', 'defaultContent': '', 'width': '10%' },
				{ 'data' : 'hit', 'defaultContent': '', 'width': '10%'	},
