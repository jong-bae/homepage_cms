			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-left">
						...
						<li class="breadcrumb-item active">MRI 치료수기 관리</li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="col-12">
					<div class="card card-primary card-outline">
						<div class="card-header">
								<h3 class="card-title">MRI 치료수기 목록</h3>
						</div>
						<div class="card-body">
							<form class="form-horizontal">
								<div class="form-group row">
									...
									<div class="col-md-10">
										...
										<!-- <button type="button" class="btn btn-primary float-right" onClick="location.href='write.do'">등록</button> -->
									</div>
								</div>
							</form>
			...
			columns : [
				{ 'data' : 'strFirstImg', 'defaultContent': '', 'width': '20%'	,
					render: function (data, type, row, meta){
						//console.log(data);
						//return data;
						return '<img src="/Upload/16/'+data+'" height="150">';
