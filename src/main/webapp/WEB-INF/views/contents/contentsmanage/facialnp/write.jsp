			...
			<div class="col-12">
				<div class="card card-info">
					<div class="card-header">
						<h3 class="card-title">안면신경마비 등록</h3>
					</div>
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="disease" class="form-control" id="disease" value="안면신경마비" required="required">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="strMImage" class="form-control" id="strMImage" placeholder="홈페이지  이미지 링크" required="required">
							</div>
						</div>
						
						<div class="form-group row">
							<label for="title" class="col-sm-2 col-form-label"><strong style="color:red;">내용 입력시 필수내용</strong></label>
							<div class="col-sm-5">
