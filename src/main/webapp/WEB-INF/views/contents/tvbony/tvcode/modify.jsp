						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									...
									<script>
										$('input:radio[name="gubun"]:radio[value="${data.gubun}"]').prop('checked', true);
									</script>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<input type="text" name="title" class="form-control" id="title" value='<c:out value="${data.title }"></c:out>'  placeholder="" >
								</div>
								<div class="col-sm-2">
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-1">
										<div class="icheck-primary d-inline">
											<input type="radio" id="useY" name="real_yn" value="Y" ${data.real_yn == 'Y' ? 'checked' : '' }>
											<label for="useY">노출</label>
										</div>
									</div>
									<div class="col-sm-2">
										<div class="icheck-primary d-inline">
											<input type="radio" id="useN" name="real_yn" value="N" ${data.real_yn == 'N' ? 'checked' : '' }>
