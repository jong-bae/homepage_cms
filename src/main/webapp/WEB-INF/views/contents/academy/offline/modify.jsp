			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-left">
						...
						<li class="breadcrumb-item active">오프라인 교육과정 등록</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="col-12">
				<div class="card card-info">
					<div class="card-header">
						<h3 class="card-title">오프라인 교육과정 등록</h3>
					</div>
					...
					<div class="card-body">
						...
						<div class="form-group row">
							<label for="gubun" class="col-sm-2 col-form-label">카테고리 구분</label>
							<div class="col-sm-2">
								<select class="form-control select2" id="gubun" name="gubun">
									<option value="">선택</option>
									<option value="1">의예과 및 의대생</option>
									<option value="2">의대생</option>
									<option value="3">의대 3,4학년 학생</option>
									<option value="4">의료진</option>
								</select>
								<script>
